...
O objetivo desses exercício foi colocar em prática o que aprendi sobre HTML semântico.

##A sequencia de exercicio foi:
...
Adicione um rodapé na página, mostrando algo do gênero com a identificação do nome e ano de publicação.