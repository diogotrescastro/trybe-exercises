...
if (a > b) {
  console.log("'variavel a' > 'variavel b'");
} else {
  console.log("'variavel b' > ' variavel a'");
};
...
if (c>d && c>e){
  console.log('a maior variavel é "c"='+c)
}else if (d>c && d>e){
  console.log('a maior variavel é "d"='+d)
}else{
  console.log('a maior variavel é "e"='+e)
}
...
console.log('Salário Liquido: R$ ' + (salarioBase - taxaIr));